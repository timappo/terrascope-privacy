...
> 🔒 A formatted version of this page is also available at
> **https://timappo.github.io/terrascope-privacy/**
...
- If it's about a specific world, roughly how large it is (small / medium / large)
...
No. Everything is parsed and rendered locally on your device. Nothing is uploaded.

**Which Terraria version is supported?**
Terraria 1.4.5.x world files (format version v319). Older formats may not load.

**The minimap looks blank or says "too large to render."**
Very large worlds are capped for memory safety. Try reloading the world, or reopening
the app if it has been in the background for a long time.
